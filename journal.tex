...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Group:} \mytodo{Your Group Number}
...
% Replace the text below with your own content.
\mytodo{
Reflect on how the group is functioning:
\begin{itemize}[leftmargin=1.5em]
  \item Communication within the group
  \item How meetings are organised and run
  \item How fairly work is divided
  \item Any challenges and how you are addressing them
\end{itemize}

You should be honest but constructive, bearing in mind that other group members may read this.
}
...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item What you have learned about working in a team
  \item How you plan to improve your contribution in the next phase
\end{itemize}
}
...
\textbf{Task ID} & \textbf{Responsible} & \textbf{Due Date} & \textbf{Description} \\
\midrule
T1 & Member A & DD/MM & Short description of the task \\
T2 & Member B & DD/MM & Short description of the task \\
T3 & Member C & DD/MM & Short description of the task \\
% Add more rows as needed
\bottomrule
\end{tabularx}
...
\paragraph{Tasks Agreed}
None (Finalised and practiced group powerpoint).
}
...
\textbf{Task ID} & \textbf{Responsible} & \textbf{Due Date} & \textbf{Description} \\
\midrule
T1 & Ben (1101977) & 18/12 & Complete their journal version \\
T2 & Naddy (11011468) & 18/12 & Complete their journal version \\
T3 & David (11054893) & 18/12 & Complete their journal version \\
T4 & Daniel (11017362) & 18/12 & Complete their journal version \\
\bottomrule
\end{tabularx}
...
12/12/2025, 10:00 & Room & Ben, Naddy, David, Daniel & Continued work on current approaches, updated teammates on progress. \\
15/12/2025, 13:00 & Hybrid & Ben, Naddy, David, Daniel & Compared bots and finlised log \\
